...
public class JMXServiceTest {
    ...
    @Test
    public void testGetHeapMemoryUsage() throws MalformedObjectNameException,
                                        NullPointerException,
                                        InstanceNotFoundException {
        CompositeDataSupport compositeDataSupport = (CompositeDataSupport) service.getAttribute(jmxServiceURL,
                                                                                                ManagementFactory.MEMORY_MXBEAN_NAME,
                                                                                                "HeapMemoryUsage");
        assertTrue("Used heap should be greater than zero",
                   (Long) compositeDataSupport.get("used") > 0);
    }

    @Test
    public void testGetJettyVersion() throws MalformedObjectNameException,
                                     NullPointerException,
                                     InstanceNotFoundException {
        String version = (String) service.getAttribute(jmxServiceURL,
